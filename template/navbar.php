...
<!--                         <img src="assets/images/logo-text.png" alt="homepage" class="dark-logo" />-->
                        <!-- Light Logo text -->
                         <img src="assets/images/my-logo-light-text.png" class="light-logo" alt="homepage" />
                    </span>
                </a>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav my-lg-0">
                    ...
                    <li class="nav-item">
                        <button class="right-side-toggle waves-effect waves-light btn-success btn-circle btn-sm pull-right m-l-10 mt-3">
